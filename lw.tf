...
resource "null_resource" "null1"  {
    ...
    provisioner "local-exec" { command = "git clone https://github.com/ShrutShah/terra1.git C:/Users/shahs/Desktop/terra" }
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/ShrutShah/terra1.git /var/www/html/"
    ]
  }
...
resource "aws_s3_bucket_object" "bucket_object" {
  ...
  source = "C:/Users/shahs/Desktop/terra/sea.jpg"
  acl    = "public-read"
  force_destroy = true
}
...
resource "aws_cloudfront_distribution" "distribution" {
    ...
    origin {
        domain_name = "sh123.s3.amazonaws.com"
        origin_id   = "S3-sh123" 
